impl Api {
    ...
    pub async fn account_ratings(&self, auth: &crate::Token, name: &str, params: &crate::param::Ratings) -> crate::Result<crate::Pager<crate::Channel>> {
        self.get(&format!("/accounts/{}/ratings", name), params, Some(auth)).await
    }
}
